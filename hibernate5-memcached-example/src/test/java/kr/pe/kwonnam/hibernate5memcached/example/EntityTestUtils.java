package kr.pe.kwonnam.hibernate5memcached.example;

import kr.pe.kwonnam.hibernate5memcached.Hibernate5MemcachedRegionFactory;
import kr.pe.kwonnam.hibernate5memcached.spymemcached.KryoTranscoder;
import kr.pe.kwonnam.hibernate5memcached.spymemcached.SpyMemcachedAdapter;
...
public class EntityTestUtils {
    ...
    public static void init() {
        ...
        props.put(AvailableSettings.CACHE_REGION_FACTORY, Hibernate5MemcachedRegionFactory.class.getName());
        props.put(AvailableSettings.CACHE_REGION_PREFIX, "cachetest");
        props.put(AvailableSettings.CACHE_PROVIDER_CONFIG, "META-INF/h5m-properties.xml");
        props.put(AvailableSettings.HBM2DDL_AUTO, "create");
        props.put(AvailableSettings.USE_STRUCTURED_CACHE, "false");
        props.put(Hibernate5MemcachedRegionFactory.MEMCACHED_ADAPTER_CLASS_PROPERTY_KEY,
        ...
        props.put(SpyMemcachedAdapter.CACHE_KEY_PREFIX_PROPERTY_KEY, "h5m");
