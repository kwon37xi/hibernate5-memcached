...
import kr.pe.kwonnam.hibernate5memcached.example.entity.Author;
import kr.pe.kwonnam.hibernate5memcached.example.entity.Book;
...
public class CacheTest {
    ...
    public void testHibernateCache() {
        ...
        withEM(em -> log.debug("book after saved read again : {}", em.find(Book.class, 3L)));
