...
public class MemcachedRegionAccessStrategy implements RegionAccessStrategy {
    ...
    public boolean putFromLoad(SharedSessionContractImplementor session, Object key, Object value, long txTimestamp, Object version) throws CacheException {
        return putFromLoad(session, key, value, txTimestamp, version, isMinimalPutsEnabled());
    }
    ...
    /**
     * @see org.hibernate.cache.spi.access.RegionAccessStrategy#remove(SharedSessionContractImplementor, Object)
     */
    @Override
