...
import kr.pe.kwonnam.hibernate5memcached.timestamper.FakeHibernateCacheTimestamper;
...
public class Hibernate5MemcachedRegionFactoryTest {
    @Rule
    ...
    @Spy
    private Hibernate5MemcachedRegionFactory regionFactory = new Hibernate5MemcachedRegionFactory();
    ...
    public void populateMemcachedProvider_no_property() throws Exception {
        ...
        expectedException.expectMessage(CoreMatchers.containsString(Hibernate5MemcachedRegionFactory
    ...
    public void populateMemcachedProvider() throws Exception {
        ...
        properties.setProperty(Hibernate5MemcachedRegionFactory.MEMCACHED_ADAPTER_CLASS_PROPERTY_KEY,
    ...
    public void populateCacheProviderConfigProperties_normal_properties() throws Exception {
        ...
        sessionFactoryProperties.setProperty(AvailableSettings.CACHE_PROVIDER_CONFIG,
                "kr/pe/kwonnam/hibernate5memcached/util/normal.properties");
    ...
    public void populateTimestamper_default() throws Exception {
        Properties properties = new Properties();
        SessionFactoryOptions settings = new TestingSettingsBuilder().build();
        ...
        assertThat(timestamper).isExactlyInstanceOf(Hibernate5MemcachedRegionFactory.DEFAULT_TIMESTAMPER_CLASS);
    }

    @Test
    public void populateTimestamper() throws Exception {
        Properties properties = new Properties();
        properties.setProperty(Hibernate5MemcachedRegionFactory.TIMESTAMPER_PROPERTY_KEY,
    ...
    public void getDefaultAccessType() throws Exception {
        assertThat(regionFactory.getDefaultAccessType()).isEqualTo(Hibernate5MemcachedRegionFactory.DEFAULT_ACCESS_TYPE);
    }
