...
public class PropertiesUtilsTest {
    ...
    public void loadFromClasspath_normal_properties() throws Exception {
        Properties properties = PropertiesUtils.loadFromClasspath("kr/pe/kwonnam/hibernate5memcached/util/normal.properties");
    ...
    public void loadFromClasspath_xml_properteis() throws Exception {
        Properties properties = PropertiesUtils.loadFromClasspath("kr/pe/kwonnam/hibernate5memcached/util/xml_properties.xml");
        assertThat(properties).hasSize(1);
