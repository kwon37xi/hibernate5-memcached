...
/**
 * SpymemcachedAdapter for hibernate5memcached.
 *
 * @author KwonNam Son (kwon37xi@gmail.com)
 */
public class SpyMemcachedAdapter implements MemcachedAdapter {
    public static final String PROPERTY_KEY_PREFIX = "h5m.adapter.spymemcached";
    ...
    public static final int DEFAULT_NAMESPACE_SEQUENCE_EXPIRY_SECONDS = Hibernate5MemcachedRegionFactory.MEMCACHED_MAX_EPIRY_SECONDS;
